...
def _manifest_payload(manifest: CapabilityManifest) -> dict[str, Any]:
    return {
        ...
        "required_credentials": sorted(manifest.required_credentials),
...
def _manifest_from_mapping(data: dict[str, Any]) -> CapabilityManifest:
    ...
    return CapabilityManifest(
        ...
        owner_id=str(data.get("owner_id") or data["publisher_id"]),
        ...
        required_credentials=_as_set("required_credentials"),
